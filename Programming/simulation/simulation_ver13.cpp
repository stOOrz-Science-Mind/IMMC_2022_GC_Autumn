...
//						cout<<"&";
				...
				else if(point_dist(cs[k].center, sites[crsrd_num]) <= Length(cs[k].Direction) * 0.5) cs[k].next_turn = 1,cs[k].center = sites[crsrd_num]; //cout<<"``````````````````````````````````";//ÅĞ¶Ï×ªÍä 
